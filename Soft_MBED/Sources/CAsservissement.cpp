...
void CAsservissement::Init(void) 
{
 ...
 kp_distance =  1.0;		// 		Gain proportionnel pour la régulation en distance
 ki_distance =  1.0;		// 		Gain intégral pour la régulation en distance
 kp_angle =  0.1;			// 		Gain proportionnel pour la régulation en angle
 ki_angle =  0.1;			// 		Gain intégral pour la régulation en angle
 ...
 seuil_conv_angle =  0.5;	// rad	Erreur en dessous de laquelle on considère que le robot est en position sur l'angle
